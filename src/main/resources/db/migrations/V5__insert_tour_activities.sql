...
('Tour đi bộ tham quan thành phố có hướng dẫn viên', 'Hanoi', 'Trong tour riêng này, bạn sẽ được đi bộ và khám phá một số điểm tham quan nổi bật nhất ở Hà Nội. Trước tiên, bạn sẽ cùng hướng dẫn viên ghé Hồ Hoàn Kiếm, nơi được đông đảo người dân địa phương xem là trung tâm thủ đô. Từ đây, bạn sẽ tham quan các địa điểm nổi bật khác như Lăng Chủ tịch Hồ Chí Minh, Nhà sàn Bác Hồ, Phủ Chủ tịch, Bảo tàng Hồ Chí Minh, Chùa Một Cột, cùng nhiều điểm tham quan nổi tiếng khác. Ngoài ra, bạn sẽ được khám phá hai địa danh được bảo tồn kỹ lưỡng và mang tính biểu tượng là Văn Miếu và Đại học Quốc gia. Xuyên suốt tour, hướng dẫn viên sẽ cung cấp nhiều thông tin về Phố cổ, lịch sử, văn hóa và kiến trúc ở Hà Nội.', 2, 1),
